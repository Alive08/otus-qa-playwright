...
from pages.store.account import AccountErrors, CustomerAccount
...
class TestCustomerScenarios:
    ...
    @allure.severity(allure.severity_level.BLOCKER)
    def test_register_account(self, customer_page: CustomerAccount, account_valid, db_delete_customer_valid):
        customer_page.new_account_continue_button.click()
    ...
    def test_register_account_duplicate_data(self, customer_page: CustomerAccount, account_valid, db_customer_valid):
        customer_page.new_account_continue_button.click()
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_register_account_privacy_policy_unchecked(self, customer_page: CustomerAccount, account_random):
    ...
    def test_register_passwords_mismatch(self, customer_page: CustomerAccount, account_random):
        customer_page.new_account_continue_button.click()
    ...
    def test_try_register_account_with_errors(self, customer_page: CustomerAccount, account_random, field, expected):
        account_random.password_2 = account_random.password_1
